    ...
    const result = plain([
      {
        "fieldName": "a", "type": "NO_CHAGES", "value": [
          ...
          {
            "fieldName": "c", "type": "NO_CHAGES", "value": [
              {
                "fieldName": "d", "type": "NO_CHAGES", "value": [
...
Property 'g.h' was updated. From 'h' to 'hh'`);
  ...
  it('should show property was updated with plain and complex values', () => {
    const result = plain([
            ...
            "fieldName": "c", "type": "NO_CHAGES", "value": [
              {
                "fieldName": "d", "type": "NO_CHAGES", "value": [
                  {
                    "fieldName": "e", "type": "BOTH_CHANGED", "valueLeft": "", "valueRight": [
      ...
      {
        "fieldName": "f", "type": "BOTH_CHANGED", "valueLeft": false, "valueRight": [
      ...
      },
      {
        "fieldName": "g", "type": "NO_CHAGES", "value": [
          {
            "fieldName": "h", "type": "BOTH_CHANGED", "valueLeft": "h", "valueRight": [
      ...
      {
        "fieldName": "i", "type": "BOTH_CHANGED", "valueLeft": [
...
Property 'e' was removed`)
  ...
  it('should ignore the same values', () => {
    const result = plain([
      ...
      {
        "fieldName": "b", "type": "NO_CHAGES", "value": [
